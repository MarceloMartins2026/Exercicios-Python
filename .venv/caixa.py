...
class Caixa(QWidget):
    ...
    def keyPressEvent(self, e):
        if(e.key()==Qt.Key.Key_F3):
            ...
            sub = float(self.edit_quantidade_produto.text()) * float(self.edit_preco_unitario_produto.text())
            ...
            self.tabel_produtos.setItem(self.linha,3,QTableWidgetItem(self.edit_preco_unitario_produto.text()))
            self.tabel_produtos.setItem(self.linha,4,QTableWidgetItem(self.edit_sub_total_produto.text()))
            self.linha+=1
            ...
            self.edit_preco_unitario_produto.setText("")
